...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.codenotfound.grpc.helloworld.HelloService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.codenotfound.grpc.helloworld.HelloRequest,
      com.codenotfound.grpc.helloworld.HelloResponse> METHOD_HELLO =
      io.grpc.MethodDescriptor.<com.codenotfound.grpc.helloworld.HelloRequest, com.codenotfound.grpc.helloworld.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.codenotfound.grpc.helloworld.HelloService", "hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.codenotfound.grpc.helloworld.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.codenotfound.grpc.helloworld.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.codenotfound.grpc.helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.codenotfound.grpc.helloworld.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.codenotfound.grpc.helloworld.HelloRequest,
                com.codenotfound.grpc.helloworld.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.codenotfound.grpc.helloworld.HelloResponse hello(com.codenotfound.grpc.helloworld.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.codenotfound.grpc.helloworld.HelloResponse> hello(
        com.codenotfound.grpc.helloworld.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.codenotfound.grpc.helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.codenotfound.grpc.helloworld.HelloResponse>) responseObserver);
          break;
        default:
